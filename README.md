...
13 . Alocação de Memória no tipo Value e do Tipo Reference - entendendo como são reservados valores na memória quando passados um tipo value, tipo que gera uma marcação na memória, e um tipo refence, que pode apontar para vários espaços na memória.
